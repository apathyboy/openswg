...
{
	class OS_SOEPROTOCOL_EXPORT SOESessionManager : public gsServer::SessionManager
    {        
    public:
        SOESessionManager();
    ...
    public: // gsCore::Process virtual overrides
        ...
        inline uint32 generateRandomCrcSeed() {
            uint32 crcSeed;
            srand((unsigned int)time(0));
            unicode *test = GS_NEW unicode[2];
            uint16 randomNum = rand()%65535;
