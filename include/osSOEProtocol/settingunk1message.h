...
#ifndef OPENSWG_SOEPROTOCOL_SETTINGUNK1MESSAGE
#define OPENSWG_SOEPROTOCOL_SETTINGUNK1MESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT SettingUnk1Message : public gsNetwork::NetworkMessage
	{
	public:
		SettingUnk1Message();
...
#endif // OPENSWG_SOEPROTOCOL_SETTINGUNK1MESSAGE