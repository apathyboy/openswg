...
#ifndef OPENSWG_SOEPROTOCOL_NETSTATUSRESPONSEMESSAGE
#define OPENSWG_SOEPROTOCOL_NETSTATUSRESPONSEMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT NetStatusResponseMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint16 tick;
...
#endif // OPENSWG_SOEPROTOCOL_NETSTATUSRESPONSEMESSAGE
