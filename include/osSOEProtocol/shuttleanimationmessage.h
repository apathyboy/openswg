...
#ifndef OPENSWG_SOEPROTOCOL_SHUTTLEANIMATIONMESSAGE
#define OPENSWG_SOEPROTOCOL_SHUTTLEANIMATIONMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT ShuttleAnimationMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint64 objectId;
		uint8 posture;
...
#endif // OPENSWG_SOEPROTOCOL_SHUTTLEANIMATIONMESSAGE
