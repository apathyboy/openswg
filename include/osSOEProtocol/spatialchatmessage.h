...
#ifndef OPENSWG_SOEPROTOCOL_SPATIALCHATMESSAGE
#define OPENSWG_SOEPROTOCOL_SPATIALCHATMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT SpatialChatMessage : public gsNetwork::NetworkMessage
	{
	public:
		std::string message;
		uint64 targetId;
...
#endif // OPENSWG_SOEPROTOCOL_SPATIALCHATMESSAGE