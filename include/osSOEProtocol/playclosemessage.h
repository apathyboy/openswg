...
#ifndef OPENSWG_SOEPROTOCOL_PLAYCLOSEMESSAGE
#define OPENSWG_SOEPROTOCOL_PLAYCLOSEMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT PlayCloseMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint64 objectId;
		PlayCloseMessage();
...
#endif // OPENSWG_SOEPROTOCOL_PLAYCLOSEMESSAGE