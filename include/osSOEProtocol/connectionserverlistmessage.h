...
#ifndef OPENSWG_SOEPROTOCOL_CONNECTIONSERVERLISTMESSAGE
#define OPENSWG_SOEPROTOCOL_CONNECTIONSERVERLISTMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT ConnectionServerListMessage : public gsNetwork::NetworkMessage
	{
	public:
...
#endif // OPENSWG_SOEPROTOCOL_CONNECTIONSERVERLISTMESSAGE
