...
#ifndef OPENSWG_SOEPROTOCOL_ANIMATIONMESSAGE
#define OPENSWG_SOEPROTOCOL_ANIMATIONMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT AnimationMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint64 objectId;
		uint8 posture;
...
#endif // OPENSWG_SOEPROTOCOL_ANIMATIONMESSAGE
