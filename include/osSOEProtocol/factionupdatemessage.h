...
#ifndef OPENSWG_SOEPROTOCOL_FACTIONUPDATEMESSAGE
#define OPENSWG_SOEPROTOCOL_FACTIONUPDATEMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT FactionUpdateMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint64 objectId;
		uint32 type;
...
#endif // OPENSWG_SOEPROTOCOL_FACTIONUPDATEMESSAGE