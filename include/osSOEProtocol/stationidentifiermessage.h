...
#ifndef OPENSWG_SOEPROTOCOL_STATIONIDENTIFIERMESSAGE
#define OPENSWG_SOEPROTOCOL_STATIONIDENTIFIERMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT StationIdentifierMessage : public gsNetwork::NetworkMessage
	{
	public:
...
#endif // OPENSWG_SOEPROTOCOL_STATIONIDENTIFIERMESSAGE
