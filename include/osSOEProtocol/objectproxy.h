...
namespace osSOEProtocol
{
	...
	class OS_SOEPROTOCOL_EXPORT ObjectProxy
	{
	public:
		ObjectProxy();
	...
	public: // Radial System Methods
		virtual void radialSelection(uint8 option, gsServer::Session* session);
	...
	typedef OS_SOEPROTOCOL_EXPORT boost::shared_ptr<ObjectProxy> ObjectProxyPtr;
}
