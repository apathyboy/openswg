...
#ifndef OPENSWG_SOEPROTOCOL_CHARACTEROPTIONSVALIDATIONREQUEST
#define OPENSWG_SOEPROTOCOL_CHARACTEROPTIONSVALIDATIONREQUEST
...
{
	class OS_SOEPROTOCOL_EXPORT CharacterOptionsValidationRequest : public gsNetwork::NetworkMessage
	{
	public:
...
#endif // OPENSWG_SOEPROTOCOL_CHARACTEROPTIONSVALIDATIONREQUEST
