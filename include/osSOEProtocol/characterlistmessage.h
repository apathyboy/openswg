...
#ifndef OPENSWG_SOEPROTOCOL_CHARACTERLISTMESSAGE
#define OPENSWG_SOEPROTOCOL_CHARACTERLISTMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT CharacterListMessage : public gsNetwork::NetworkMessage
	{
	public:
...
#endif // OPENSWG_SOEPROTOCOL_CHARACTERLISTMESSAGE
