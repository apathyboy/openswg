...
#ifndef OPENSWG_SOEPROTOCOL_ASSIGNCHARACTERIDMESSAGE
#define OPENSWG_SOEPROTOCOL_ASSIGNCHARACTERIDMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT AssignCharacterIdMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint64 characterId;
...
#endif // OPENSWG_SOEPROTOCOL_ASSIGNCHARACTERIDMESSAGE
