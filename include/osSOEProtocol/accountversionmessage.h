...
#ifndef OPENSWG_SOEPROTOCOL_ACCOUNTVERSIONMESSAGE
#define OPENSWG_SOEPROTOCOL_ACCOUNTVERSIONMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT AccountVersionMessage : public gsNetwork::NetworkMessage
	{
	public:
		std::string username;
		std::string password;
...
#endif // OPENSWG_SOEPROTOCOL_ACCOUNTVERSIONMESSAGE
