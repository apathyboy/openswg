...
#ifndef OPENSWG_SOEPROTOCOL_SESSIONREQUESTMESSAGE
#define OPENSWG_SOEPROTOCOL_SESSIONREQUESTMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT SessionRequestMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint32 connectionId;
...
#endif // OPENSWG_SOEPROTOCOL_SESSIONREQUESTMESSAGE
