...
#ifndef OPENSWG_SOEPROTOCOL_POSTUREUPDATEMESSAGE
#define OPENSWG_SOEPROTOCOL_POSTUREUPDATEMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT PostureUpdateMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint64 objectId;
		uint8 posture;
...
#endif // OPENSWG_SOEPROTOCOL_POSTUREUPDATEMESSAGE
