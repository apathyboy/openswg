...
#ifndef OPENSWG_SOEPROTOCOL_CREOINITMESSAGE
#define OPENSWG_SOEPROTOCOL_CREOINITMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT CreoInitMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint64 objectId;
		float quaternionX; 
...
#endif // OPENSWG_SOEPROTOCOL_CREOINITMESSAGE