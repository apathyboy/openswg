...
#ifndef OPENSWG_SOEPROTOCOL_OBJPRECLOSEMESSAGE
#define OPENSWG_SOEPROTOCOL_OBJPRECLOSEMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT ObjPreCloseMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint64 objectId;
...
#endif // OPENSWG_SOEPROTOCOL_OBJPRECLOSEMESSAGE