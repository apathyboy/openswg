...
#ifndef OPENSWG_SOEPROTOCOL_RADIALRESPONSEMESSAGE
#define OPENSWG_SOEPROTOCOL_RADIALRESPONSEMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT RadialResponseMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint64 objectId;
		uint64 targetId;
		RadialMenuMap radialMap;
		uint8 defaultOption;
...
#endif // OPENSWG_SOEPROTOCOL_RADIALRESPONSEMESSAGE
