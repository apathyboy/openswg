...
#ifndef OPENSWG_SOEPROTOCOL_OBJLINKMESSAGE
#define OPENSWG_SOEPROTOCOL_OBJLINKMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT ObjLinkMessage : public gsNetwork::NetworkMessage
	{
	public:
		enum LinkTypes
		{
...
#endif // OPENSWG_SOEPROTOCOL_OBJLINKMESSAGE