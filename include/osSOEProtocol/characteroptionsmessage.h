...
#ifndef OPENSWG_SOEPROTOCOL_CHARACTEROPTIONSMESSAGE
#define OPENSWG_SOEPROTOCOL_CHARACTEROPTIONSMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT CharacterOptionsMessage : public gsNetwork::NetworkMessage
	{
	public:
...
#endif // OPENSWG_SOEPROTOCOL_CHARACTEROPTIONSMESSAGE
