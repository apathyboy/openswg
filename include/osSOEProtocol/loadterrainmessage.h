...
#ifndef OPENSWG_SOEPROTOCOL_LOADTERRAINMESSAGE
#define OPENSWG_SOEPROTOCOL_LOADTERRAINMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT LoadTerrainMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint64 objectId;
		uint64 zoneId;
...
#endif // OPENSWG_SOEPROTOCOL_LOADTERRAINMESSAGE