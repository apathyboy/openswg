...
#ifndef OPENSWG_SOEPROTOCOL_ACKNOWLEDGEMESSAGE
#define OPENSWG_SOEPROTOCOL_ACKNOWLEDGEMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT AcknowledgeMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint16 sequence;
...
#endif // OPENSWG_SOEPROTOCOL_ACKNOWLEDGEMESSAGE
