...
#ifndef OPENSWG_SOEPROTOCOL_COMPRESSION
#define OPENSWG_SOEPROTOCOL_COMPRESSION
...
{
    class OS_SOEPROTOCOL_EXPORT Compression
    {
    public:
...
#endif // OPENSWG_SOEPROTOCOL_COMPRESSION
