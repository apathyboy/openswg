...
#ifndef OPENSWG_SOEPROTOCOL_CHARACTERCREATIONREQUEST
#define OPENSWG_SOEPROTOCOL_CHARACTERCREATIONREQUEST
...
{
	class OS_SOEPROTOCOL_EXPORT CharacterCreationRequest : public gsNetwork::NetworkMessage
	{
	public:
		std::string category;
		std::string type;
...
#endif // OPENSWG_SOEPROTOCOL_CHARACTERCREATIONREQUEST
