...
#ifndef OPENSWG_SOEPROTOCOL_DISCONNECTMESSAGE
#define OPENSWG_SOEPROTOCOL_DISCONNECTMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT DisconnectMessage : public gsNetwork::NetworkMessage
	{
	public:
		uint32 connectionId;
...
#endif // OPENSWG_SOEPROTOCOL_DISCONNECTMESSAGE
