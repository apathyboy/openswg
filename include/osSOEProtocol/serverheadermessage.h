...
#ifndef OPENSWG_SOEPROTOCOL_SERVERHEADERMESSAGE
#define OPENSWG_SOEPROTOCOL_SERVERHEADERMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT ServerHeaderMessage : public gsNetwork::NetworkMessage
	{
	public:
...
#endif // OPENSWG_SOEPROTOCOL_SERVERHEADERMESSAGE