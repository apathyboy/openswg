...
{
	class OS_SOEPROTOCOL_EXPORT CreatureObjectProxy : public ObjectProxy
	{
	public:
		CreatureObjectProxy();
	...
	typedef OS_SOEPROTOCOL_EXPORT boost::shared_ptr<CreatureObjectProxy> CreatureObjectProxyPtr;
}
