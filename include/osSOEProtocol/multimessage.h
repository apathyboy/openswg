...
#ifndef OPENSWG_SOEPROTOCOL_MULTIMESSAGE
#define OPENSWG_SOEPROTOCOL_MULTIMESSAGE
...
{
	class OS_SOEPROTOCOL_EXPORT MultiMessage : public gsNetwork::NetworkMessage
	{
	public:
...
#endif // OPENSWG_SOEPROTOCOL_MULTIMESSAGE
