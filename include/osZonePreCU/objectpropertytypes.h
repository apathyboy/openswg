...
#ifndef OPENSWG_ZONEPRECU_OBJECTPROPERTYTYPES
#define OPENSWG_ZONEPRECU_OBJECTPROPERTYTYPES

#include <gsCore/callback.h>
#include <osZonePreCU/objectproperty.h>
...
namespace osZonePreCU
{
	...
	class UintObjectProperty : public GenericObjectProperty<uint,uint>
	{
	public:
	...
	class Uint8ObjectProperty : public GenericObjectProperty<uint8,uint8>
	{
	public:
	...
	class Uint16ObjectProperty : public GenericObjectProperty<uint16,uint16>
	{
	public:
	...
	class Uint32ObjectProperty : public GenericObjectProperty<uint32,uint32>
	{
	public:
	...
	class Uint64ObjectProperty : public GenericObjectProperty<uint64,uint64>
	{
	public:
...
#endif // OPENSWG_ZONEPRECU_OBJECTPROPERTYTYPES
