...
#ifndef OPENSWG_ZONEPRECU_PLAYERCREATUREOBJECTPROXY
#define OPENSWG_ZONEPRECU_PLAYERCREATUREOBJECTPROXY

#include <osZonePreCU/creatureobjectproxy.h>
#include <osZonePreCU/tangibleobjectproxy.h>
...
{		
	class PlayerCreatureObjectProxy : public CreatureObjectProxy
	{
	public:
...
#endif // OPENSWG_ZONEPRECU_PLAYERCREATUREOBJECTPROXY
