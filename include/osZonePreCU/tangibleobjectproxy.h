...
#ifndef OPENSWG_ZONEPRECU_TANGIBLEOBJECTPROXY
#define OPENSWG_ZONEPRECU_TANGIBLEOBJECTPROXY

#include <osZonePreCU/objectproxy.h>
#include <osZonePreCU/tangibleobject.h>
...
#endif // OPENSWG_ZONEPRECU_TANGIBLEOBJECTPROXY
