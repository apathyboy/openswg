...
#ifndef OPENSWG_ZONEPRECU_OBJECTGRID
#define OPENSWG_ZONEPRECU_OBJECTGRID
...
namespace osZonePreCU
{
	...
	public:
		...
		void update(uint64 updateTimestamp);
		...
		void sendInRange(uint64 target, boost::shared_ptr<gsNetwork::NetworkMessage> message);

		boost::optional<Object*> findObjectById(uint64 objectId);
...
#endif // OPENSWG_ZONEPRECU_OBJECTGRID