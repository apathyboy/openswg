...
namespace gsCore
{
     ...
     * imposed or assumed.
     */
    class GS_CORE_EXPORT IEventListener
    {
    public:
    ...
    typedef GS_CORE_EXPORT boost::shared_ptr<IEventListener> EventListenerPtr;

    /** Event listener used for snooping ... simply emits event stats
     *  for all processed & known events to runtime log 
     */
     class GS_CORE_EXPORT EventSnooper : public IEventListener
     {
     public:
