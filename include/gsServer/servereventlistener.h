...
namespace gsServer
{
	class GS_SERVER_EXPORT ServerEventListener : public gsCore::IEventListener
	{
    public:
        ServerEventListener(ServerApplication* server);
        virtual ~ServerEventListener();
        char const * getName(void) { return "ServerEventListener"; }
...
#endif // GALAXY_SERVER_SERVEREVENTLISTENER
