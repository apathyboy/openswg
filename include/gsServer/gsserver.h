...
#ifndef GALAXY_GSSERVER
#define GALAXY_GSSERVER

#include <gsServer/server.h>
...
namespace gsServer
{
    ...
    #undef GS_H_GSSERVER_LIB

    // Setup debug vs. release library names
    #if defined(_DEBUG)
        #ifndef GS_SERVER_LIBRARY  
            #define  GS_H_GSSERVER_LIB "gsServerd.lib"
        #endif
    #else
        #ifndef GS_SERVER_LIBRARY
            #define GS_H_GSSERVER_LIB "gsServer.lib"
        #endif
    #endif
    ...
    // You may turn off this include message by defining _NOAUTOLIB 
        ...
        #ifndef GS_SERVER_LIBRARY
            #pragma message( "Will automatically link with " GS_H_GSSERVER_LIB )
        #endif
    #endif
    ...
    #ifndef GS_SERVER_LIBRARY
        #pragma comment(lib, GS_H_GSSERVER_LIB)
    #endif

#endif

#endif // GALAXY_GSSERVER
