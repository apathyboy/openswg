...
namespace gsServer
{
    class GS_SERVER_EXPORT SessionManager : public gsCore::Process
    {        
    ...
    public: // gsCore::Process virtual overrides
        ...
        virtual void removeDeadSessions(const uint64 updateTimestamp);
        virtual void initialize();
		virtual void queueRemoteMessage(gsNetwork::BinaryPacketPtr packet, gsNetwork::NetworkAddressPtr address);

    public:
		virtual uint countSessions() { return m_sessions.size(); }
