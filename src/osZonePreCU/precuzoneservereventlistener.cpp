...
PreCUZoneServerEventListener::PreCUZoneServerEventListener(ServerApplication* server)
: ServerEventListener(server)
{}

PreCUZoneServerEventListener::~PreCUZoneServerEventListener()
{}
	
void PreCUZoneServerEventListener::registerEvents(EventListenerPtr listener)
{
...
bool PreCUZoneServerEventListener::handleEvent(const gsCore::Event &event)
{
