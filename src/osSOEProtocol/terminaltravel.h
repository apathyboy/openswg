...
#ifndef OPENSWG_SOEPROTOCOL_TERMINALTRAVEL
#define OPENSWG_SOEPROTOCOL_TERMINALTRAVEL
...
{
	class OS_SOEPROTOCOL_EXPORT TerminalTravel : public TangibleObject
	{
	public:
		TerminalTravel() {}
		virtual ~TerminalTravel(){}
