...
void Encrypt(char *pData,unsigned short nLength,unsigned int nCRCSeed,bool header=1);
void Decrypt(char *pData,unsigned short nLength, unsigned int nCrcSeedd, bool header=true);

char *Decompress(char *pData, uint16_t &nLength);
bool Compress(char **pData, uint16_t *nLength, bool crc);
