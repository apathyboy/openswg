...
#ifndef OPENSWG_SOEPROTOCOL_TERMINALTRAVELPROXY
#define OPENSWG_SOEPROTOCOL_TERMINALTRAVELPROXY
...
{		
	class OS_SOEPROTOCOL_EXPORT TerminalTravelProxy : public TangibleObjectProxy
	{
	public:
		TerminalTravelProxy();
