...
AssignCharacterIdMessage::AssignCharacterIdMessage()
: NetworkMessage()
{
	setPriority(0);
	setResend(true);
...
AssignCharacterIdMessage::AssignCharacterIdMessage(std::shared_ptr<BinaryPacket> packet)
: NetworkMessage()
{
	setPriority(0);
	setResend(true);
...
void AssignCharacterIdMessage::unserialize()
{
}
